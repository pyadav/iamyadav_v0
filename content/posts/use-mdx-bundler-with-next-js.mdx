...
I hope this article will help you to understand how to use MDX with Next.JS using mdx-bundler. You can see a working demo at [https://use-mdx-bundler-with-next-js](https://use-mdx-bundler-with-next-js-m7antg5rw-pyadav.vercel.app/) and view the code at [GitHub](https://github.com/pyadav/use-mdx-bundler-with-next-js).
