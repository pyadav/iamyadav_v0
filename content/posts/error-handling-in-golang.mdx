...
An [idiomatic](https://en.wikipedia.org/wiki/Programming_idiom) way to handle errors in Go is to return it as last return value of the function and check for the nil condition.
...
I hope this article will help you to understand the basic of error handling in Go.
